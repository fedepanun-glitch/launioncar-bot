...
console.log("=== BOT v4.1 - SITRACK GPS UBICACION ===");
...
async function run(accion,datos,contextFrom) {
  try {
    ...
    if (accion==="ubicacion_camion") {
      ...
      // Sitrack puede devolver un objeto único o un array con varios reports
      var report = rS.data;
